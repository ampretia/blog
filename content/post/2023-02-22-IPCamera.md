...
Needed an IP Camera, to monitor our driveway; with live feed and motion detection of people. Some degree of nighttime vision as well.
...
![Synology Surveillance Station camera configuration with ONVIF and RTSP settings](/ipcamera/SynologySurveillance_1.png)
![Synology Surveillance Station camera settings interface](/ipcamera/SynologySurveillance_3.png)
...
![Portainer container management interface showing ONVIF service setup](/ipcamera/PortainerSetip.png)
...
![Node-RED flow diagram showing camera to MQTT to Surveillance Station webhook integration](/ipcamera/NodeRED_1.png)

In the Surveillance Station the action when configured will give you the webhook URL for use in the NodeRED flow.

![Synology Surveillance Station webhook configuration showing action and URL settings](/ipcamera/SynologySurveillance_4.png)
